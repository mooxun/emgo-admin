        ...
        <chart-card :loading="loading" title="总销售额" total="￥126,560">
          ...
          <div>
            <trend flag="up" style="margin-right: 16px;">
              <span slot="term">周同比 12%</span>

            </trend>
            <trend flag="down">
              <span slot="term">日同比 11%</span>
            </trend>
          </div>
        ...
        <chart-card :loading="loading" title="运营活动效果" total="78%">
          ...
          <template slot="footer">
            <trend flag="down" style="margin-right: 16px;">
              <span slot="term">同周比 12%</span>
            </trend>
            <trend flag="up">
              <span slot="term">日环比 80%</span>
            </trend>
          </template>
        </chart-card>
      </a-col>
...
import Bar from '@C/Chart/Bar';
import RankList from '@C/Chart/RankList';
